...
const Index = () => {
  ...
  const calculateTotal = () => {
    ...
    const overtimeCost =
      basePrice * 1.5 * calculator.guards * calculator.overtime;
  ...
  const services = [
    { icon: "Music", title: "Концерты", description: "Охрана концертов" },
    {
      icon: "Briefcase",
      title: "Корпоративы",
      description: "Охрана корпоративов",
    },
    {
      icon: "Sparkles",
      title: "Вечеринки",
      description: "Охрана для вечеринок",
    },
    { icon: "Heart", title: "Свадьбы", description: "Охрана для свадьбы" },
    {
      icon: "Users",
      title: "Конференции",
      description: "Охрана бизнес-конференций",
    },
    {
      icon: "Handshake",
      title: "Встречи",
      description: "Охрана бизнес-встреч",
    },
    ...
    { icon: "Calendar", title: "Праздники", description: "Охрана праздников" },
    {
      icon: "Home",
      title: "Частные",
      description: "Охрана частных мероприятий",
    },
    {
      icon: "Trophy",
      title: "Спорт",
      description: "Охрана спортивных мероприятий",
    },
    {
      icon: "Gift",
      title: "Частные праздники",
      description: "Охрана частных праздников",
    },
    {
      icon: "Baby",
      title: "Детские",
      description: "Охрана детских праздников",
    },
  ];
  ...
  const features = [
    {
      icon: "Shield",
      title: "Безопасность",
      description: "Контроль и обеспечение безопасности всех участников",
    },
    {
      icon: "UserCheck",
      title: "Контроль доступа",
      description: "Проверка приглашений и досмотр гостей",
    },
    {
      icon: "Video",
      title: "Видеонаблюдение",
      description: "Профессиональное оборудование и мониторинг",
    },
    {
      icon: "Clock",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(
        "https://functions.poehali.dev/299cc0c4-2d47-4142-a6a5-3d391b117b21",
        {
          method: "POST",
          headers: {
      ...
      if (response.ok) {
        ...
        setSubmitMessage(
          data.error || "❌ Ошибка отправки. Позвоните нам: +7 999 553-22-12",
        );
      }
    } catch (error) {
      setSubmitMessage("❌ Ошибка соединения. Позвоните нам: +7 999 553-22-12");
    } finally {
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <img
                src="https://cdn.poehali.dev/files/41844b36-8d3a-4b2a-821c-6f057a7bd6e1.png"
                alt="Логотип БУРЕВЕСТНИК-РУС"
                className="w-12 h-12"
              />
              <div>
            ...
            <div className="hidden md:flex gap-6">
              <button
                ...
                className="text-white hover:text-gold transition-colors font-montserrat text-sm"
              >
                Главная
              </button>
              <button
              ...
              <button
                onClick={() => scrollToSection("о-компании")}
                className="text-white hover:text-gold transition-colors font-montserrat text-sm"
              >
                О компании
              </button>
              ...
              <button
                onClick={() => scrollToSection("лицензии")}
                className="text-white hover:text-gold transition-colors font-montserrat text-sm"
              >
                Лицензии
              </button>
              <button
                onClick={() => scrollToSection("отзывы")}
                className="text-white hover:text-gold transition-colors font-montserrat text-sm"
              >
                Отзывы
              </button>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden bg-black/98 border-t border-gold/20 animate-in slide-in-from-top">
            <div className="container mx-auto px-4 py-6 flex flex-col gap-3">
              <button
                onClick={() => scrollToSection("главная")}
                className="text-white hover:text-gold transition-colors font-montserrat text-left py-3 border-b border-gold/10"
              >
                Главная
              </button>
              <button
      ...
      <section
        id="главная"
        className="relative pt-32 pb-20 px-4 bg-gradient-to-b from-black via-gray-dark to-black overflow-hidden"
      >
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-block mb-6 px-4 py-2 bg-gold/10 border border-gold/30 rounded-full">
              <span className="text-gold text-sm font-montserrat">
                Профессиональная охрана мероприятий
              </span>
            </div>
            ...
            <p className="text-xl text-gray-light mb-8 max-w-2xl mx-auto">
              <span className="text-gold text-2xl font-bold font-montserrat block mb-2">
                ЧОП «БУРЕВЕСТНИК-РУС»
              </span>
              обеспечит охрану порядка любых массовых мероприятий: концерты,
              корпоративы, спортивные мероприятия, бизнес-конференции
            </p>
            ...
            <div className="mt-12 grid grid-cols-3 gap-8 max-w-2xl mx-auto">
              <div className="text-center">
                <div className="text-4xl font-bold text-gold font-montserrat">
                  10+
                </div>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature, index) => (
              <Card
                key={index}
                className="bg-gray-dark border-gold/20 hover:border-gold/50 transition-all hover-scale"
              >
                <CardHeader>
      ...
      <section
        id="о-компании"
        className="py-20 px-4 bg-gradient-to-b from-black to-gray-dark"
      >
        <div className="container mx-auto">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-gold text-xl font-semibold">
                Надежная защита вашего мероприятия с 2015 года
              </p>
            </div>
              ...
              <Card className="bg-gradient-to-br from-gray-dark to-black border-gold/30">
                <CardContent className="p-8">
                  <p className="text-gray-light text-lg leading-relaxed mb-6">
                    ...
                    — это профессиональная охранная компания, специализирующаяся
                    на обеспечении безопасности массовых мероприятий любого
                    масштаба. Мы работаем в Москве и Московской области более 10
                    лет, за это время успешно обеспечили безопасность более 500
                    мероприятий.
                  </p>
                  <p className="text-gray-light text-lg leading-relaxed">
                    ...
                    с профильным образованием, прошедшие строгий отбор и
                    регулярное обучение. Мы используем современное оборудование
                    для видеонаблюдения и связи, что позволяет оперативно
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Card className="bg-black border-gold/30 hover:border-gold transition-all">
                  <CardHeader className="text-center">
                    ...
                    <CardDescription className="text-gray-light">
                      Все сотрудники имеют лицензии частного охранника и
                      регулярно проходят аттестацию
                    </CardDescription>
                  </CardHeader>
                </Card>
                ...
                <Card className="bg-black border-gold/30 hover:border-gold transition-all">
                  <CardHeader className="text-center">
                    ...
                    <CardDescription className="text-gray-light">
                      Разрабатываем план охраны с учетом специфики вашего
                      мероприятия
                    </CardDescription>
                  </CardHeader>
                </Card>
                ...
                <Card className="bg-black border-gold/30 hover:border-gold transition-all">
                  <CardHeader className="text-center">
                    ...
                    <CardDescription className="text-gray-light">
                      Работаем официально по договору со страхованием
                      ответственности
                    </CardDescription>
                  </CardHeader>
                </Card>
              ...
              <Card className="bg-gradient-to-r from-gold/10 to-gold-dark/10 border-gold/50">
                <CardContent className="p-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h3 className="text-white font-bold text-xl mb-2 font-montserrat">
                        Наша миссия
                      </h3>
                      <p className="text-gray-light">
                        Обеспечить безопасность и спокойствие на вашем
                        мероприятии, чтобы вы могли сосредоточиться на главном,
                        доверив охрану профессионалам.
                      </p>
                    </div>
                  </div>
                </CardContent>
        ...
        <div className="container mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-light text-lg">
              Профессиональная охрана любого типа мероприятий
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {services.map((service, index) => (
              <Card
                key={index}
                className="bg-gradient-to-b from-gray-dark to-black border-gold/20 hover:border-gold transition-all hover-scale cursor-pointer"
              >
                <CardHeader className="text-center">
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-gray-dark to-black">
        <div className="container mx-auto">
          ...
          <p className="text-center text-gray-light mb-12">
            Всё предельно прозрачно и просто
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              {
                step: "2",
                title: "Обсуждение специфики работы",
                icon: "FileText",
              },
      ...
      <section
        id="тарифы"
        className="py-20 px-4 bg-gradient-to-b from-gray-dark to-black"
      >
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-white mb-4 font-montserrat">
            ...
            <div className="min-w-[800px] bg-gradient-to-br from-gray-dark to-black border border-gold/30 rounded-lg">
              <div className="grid grid-cols-5 border-b border-gold/30">
                <div className="p-4 border-r border-gold/30">
                  <h3 className="text-white font-bold font-montserrat">
                    Название
                  </h3>
                </div>
                <div className="p-4 text-center border-r border-gold/30">
                  <h3 className="text-orange-400 font-bold font-montserrat">
                    Охранник-контролер:
                  </h3>
                </div>
                <div className="p-4 text-center border-r border-gold/30">
                  <h3 className="text-green-400 font-bold font-montserrat">
                    Специалист:
                  </h3>
                </div>
                <div className="p-4 text-center border-r border-gold/30">
                  <h3 className="text-cyan-400 font-bold font-montserrat">
                    Профи:
                  </h3>
                </div>
                <div className="p-4 text-center">
                  <h3 className="text-purple-400 font-bold font-montserrat">
                    Эксперт:
                  </h3>
                </div>
              </div>
              ...
              <div className="grid grid-cols-5">
                <div className="p-4 border-r border-gold/30">
                  <p className="text-gray-light text-sm">
                    Имидж, максимальная безопасность
                  </p>
                </div>
                <div className="p-4 text-center border-r border-gold/30">
                  <p className="text-gray-light">-</p>
          ...
          <div className="mt-12">
            <Card className="bg-gradient-to-br from-gray-dark to-black border-gold/30 max-w-4xl mx-auto">
              <CardHeader className="text-center">
                ...
                <CardDescription className="text-gray-light">
                  Рассчитайте приблизительную стоимость охраны вашего
                  мероприятия
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setCalculator({
                          ...calculator,
                          guards: parseInt(e.target.value) || 1,
                        })
                      }
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setCalculator({
                          ...calculator,
                          hours: Math.max(4, parseInt(e.target.value) || 4),
                        })
                      }
                      className="bg-black border-gold/30 text-white focus:border-gold"
                    />
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setCalculator({
                          ...calculator,
                          overtime: parseInt(e.target.value) || 0,
                        })
                      }
                      className="bg-black border-gold/30 text-white focus:border-gold"
                    />
                ...
                <div className="bg-gradient-to-r from-gold/20 to-gold-dark/20 border-2 border-gold rounded-lg p-6 text-center">
                  ...
                  {calculator.overtime > 0 && (
                    <p className="text-sm text-gray-light mt-2">
                      Включая {calculator.overtime} ч. переработки (
                      {(
                        tariffPrices[calculator.tariff] *
                        1.5 *
                        calculator.guards *
                        calculator.overtime
                ...
                <div className="text-center">
                  <p className="text-gray-light text-sm mb-4">
                    * Минимальный заказ — 4 часа. Каждый час переработки +50% к
                    тарифу
                  </p>
                  <Button
                    size="lg"
                    className="bg-gradient-to-r from-gold to-gold-dark text-black font-bold text-lg px-8 py-6 hover:opacity-90"
                  >
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {[
              ...
              <Card
                key={index}
                className="bg-gradient-to-br from-gray-dark to-black border-gold/20 hover:border-gold/50 transition-all"
              >
                <CardHeader>
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div>
                      <CardTitle className="text-white text-base font-montserrat">
                        {review.name}
                      </CardTitle>
                      <CardDescription className="text-gold text-sm">
                        {review.company}
                      </CardDescription>
                    </div>
                  </div>
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div
                key={index}
                className="flex items-center gap-3 bg-black/50 border border-gold/20 rounded-lg p-4"
              >
          ...
          <Card className="bg-gray-dark border-gold/30">
            <CardHeader className="text-center">
              ...
              <CardDescription className="text-gray-light text-lg">
                ...
                <br />и наш специалист свяжется с вами в ближайшее время
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {submitMessage && (
                  <p
                    className={`text-center font-semibold ${submitMessage.includes("✅") ? "text-green-400" : "text-red-400"}`}
                  >
                    {submitMessage}
                  </p>
                )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <div className="space-y-3">
                <a
                  href="tel:84990000000"
                  className="flex items-center gap-2 text-gold hover:text-gold-light transition-colors"
                >
                  ‪+7 999 553‑22‑12‬
                </a>
                <a
                  href="mailto:sales@brv-rus.ru"
                  className="flex items-center gap-2 text-gold hover:text-gold-light transition-colors"
                >
